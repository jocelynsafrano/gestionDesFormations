...
<div class="container">
	...
	{
		$db = new db();
		$db->modifierEmploye((int)$_SESSION['idModifEmploye'], $_POST['nom'], (int)$_POST['typeEmploye'], $_POST['credit'], $_POST['joursFormation']);
		echo "<div class='alert alert-success'><strong>La modification du profil a été effectuée!</strong></div>";
	}
	?>
	<div class="jumbotron">
	
	<h3><center>Modifier un profil</center></h3><br />
	
	<form action="modifEmploye.php" method="POST" accept-charset="UTF-8">

	<div class="input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		<input id="identifiant" type="text" class="form-control" name="nom" placeholder="Identifiant" required>
    </div><br />
	...
	/*
	$db = new db();
	$temp = $_POST['choixEmploye'];
	$a = $temp;*/
	if(!empty($_POST['choixEmploye']))
	{	
		$db = new db();
		$_SESSION['idModifEmploye'] = $db->selectIdEmploye($_POST['choixEmploye']);
	}
	/*var_dump((int)$_SESSION['idModifEmploye']);
	var_dump($db->selectIdEmploye($_POST['choixEmploye']));
	var_dump($_SESSION);
	var_dump($a);
	*/
	?>
